...
import { fetchInsight } from "./_lib/get_insight"
...
export default async function TicketDetailsPage({
  ...
  const insight = await fetchInsight(id, organization)
  ...
  return (
    <div className="relative flex min-h-screen flex-col bg-background font-sans text-foreground transition-colors duration-300">
      ...
      <main className="mx-auto w-full max-w-7xl flex-1 px-4 py-8 sm:px-6 lg:px-8">
        <AgentTicketChatContent insight={insight} orgSlug={organization} ticket={ticket} />
      </main>
